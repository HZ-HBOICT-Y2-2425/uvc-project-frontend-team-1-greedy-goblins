...
-->
<h2 style="color: white; margin-left: 45%; padding: 10px, 1px">
<button style="padding: 2px 10px 2px 10px" class="bg-green-500 hover:bg-green-600 rounded-lg" type="button" on:click={() => goto('/co2')}>
  CO2 Bespaart
</button>
</h2>
<!--
